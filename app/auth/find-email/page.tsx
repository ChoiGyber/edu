        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          {step === "method" && (
            <div className="space-y-4">
              ...
              <div className="flex gap-2 text-sm justify-center pt-4">
                <Link
                  href="/auth/signin"
          ...
          {step === "result" && (
            <div className="space-y-6">
              ...
              <Link
                href="/auth/find-password"
                className="block w-full text-center px-6 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition font-medium"
              >
                비밀번호 찾기
              </Link>
            </div>
